...
var swiper = new Swiper('.swiper-container', {
    ...
    onSlideChangeEnd: function(swiper) {
        switch (swiper.activeIndex) {
            case 0:
                $(".yun").addClass("yunanimation");
                $(".yun2").addClass("yun2animation");
                $(".yun3").addClass("yun3animation");
                $(".fly").addClass("flyanimation");
                $(".fly1").addClass("fly1animation");
                $(".fly2").addClass("fly2animation");
                $(".note1").addClass("note1animation");
                $(".note2").addClass("note2animation");
                $(".ellipse").addClass("ellipseanimation");
                $(".wuimg").addClass("wuimganimation");
                $(".yinfu").addClass("yinfuanimation");


                $(".video2").removeClass("videoanimation");
                $(".article").removeClass("articleanimation");
                $(".pyramid").removeClass("pyramidanimation");
                $(".ellipse2").removeClass("ellipse2animation");
                $(".ccc").removeClass("cccanimation");
                $(".ben1").removeClass("ben1animation");
                $(".rectangle").removeClass("rectangleanimation");
                $(".rectangle2").removeClass("rectangle2animation");
                $(".polygon").removeClass("polygonanimation");
                $(".polygon2").removeClass("polygon2animation");
                $(".polygon3").removeClass("polygon3animation");
                $(".yun22").removeClass("yun22animation");
                $(".yun222").removeClass("yun222animation");
                $(".yun322").removeClass("yun322animation");
                break;
            case 1:
                $(".video2").addClass("videoanimation");
                $(".article").addClass("articleanimation");
                $(".pyramid").addClass("pyramidanimation");
                $(".ellipse2").addClass("ellipse2animation");
                $(".ccc").addClass("cccanimation");
                $(".ben1").addClass("ben1animation");
                $(".rectangle").addClass("rectangleanimation");
                $(".rectangle2").addClass("rectangle2animation");
                $(".polygon").addClass("polygonanimation");
                $(".polygon2").addClass("polygon2animation");
                $(".polygon3").addClass("polygon3animation");
                $(".yun22").addClass("yun22animation");
                $(".yun222").addClass("yun222animation");
                $(".yun322").addClass("yun322animation");


                $(".yun").removeClass("yunanimation");
                $(".yun2").removeClass("yun2animation");
                $(".yun3").removeClass("yun3animation");
                $(".fly").removeClass("flyanimation");
                $(".fly1").removeClass("fly1animation");
                $(".fly2").removeClass("fly2animation");
                $(".note1").removeClass("note1animation");
                $(".note2").removeClass("note2animation");
                $(".ellipse").removeClass("ellipseanimation");
                $(".wuimg").removeClass("wuimganimation");
                $(".yinfu").removeClass("yinfuanimation");


                $(".rocketfly_wrapimg").removeClass("rocketfly_wrapimganimation");
                $(".rocket3").removeClass("rocket3animation");
                $(".good").removeClass("goodanimation");
                $(".star1").removeClass("star1animation");
                $(".star2").removeClass("star2animation");
                $(".star3").removeClass("star3animation");
                $(".star4").removeClass("star4animation");
                $(".cebian").removeClass("cebiananimation");
                $(".cebian2").removeClass("cebian2animation");
                $(".circular").removeClass("circularanimation");
                $(".circular2").removeClass("circular2animation");
                $(".ellipse3").removeClass("ellipse3animation");
                $(".circular3").removeClass("circular3animation");
                $(".yun33").removeClass("yun33animation");
                $(".yun233").removeClass("yun233animation");
                $(".yun333").removeClass("yun333animation");
                break;
            case 2:
                $(".rocketfly_wrapimg").addClass("rocketfly_wrapimganimation");
                $(".rocket3").addClass("rocket3animation");
                $(".good").addClass("goodanimation");
                $(".star1").addClass("star1animation");
                $(".star2").addClass("star2animation");
                $(".star3").addClass("star3animation");
                $(".star4").addClass("star4animation");
                $(".cebian").addClass("cebiananimation");
                $(".cebian2").addClass("cebian2animation");
                $(".circular").addClass("circularanimation");
                $(".circular2").addClass("circular2animation");
                $(".ellipse3").addClass("ellipse3animation");
                $(".circular3").addClass("circular3animation");
                $(".yun33").addClass("yun33animation");
                $(".yun233").addClass("yun233animation");
                $(".yun333").addClass("yun333animation");
...
$(".swiper-container")[0].addEventListener("touchend", function(e) {
    if ($(".threes").hasClass("swiper-slide-active")) {
